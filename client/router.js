        ...
        if (urlElements.length > 1) {
            ...
            if (urlElements[0] == "nimekirjad") {
                ...
                if (filtersString.indexOf("f") >= 0) {
                    ...
                    Session.set("nimekirjad_current_search_first_name_enabled", false);
                }
                ...
                if (filtersString.indexOf("l") >= 0) {
                    ...
                    Session.set("nimekirjad_current_search_last_name_enabled", false);                    
                }
                ...
                if (filtersString.indexOf("r") >= 0) {
                    ...
                    Session.set("nimekirjad_current_search_region_enabled", false); 
                }
                ...
                if (filtersString.indexOf("p") >= 0) {
                    ...
                    Session.set("nimekirjad_current_search_party_enabled", false);
                }
